...
const config = {
  ...
  tagline: 'Understanding ROS 2 as the middleware that connects AI agents to humanoid robot hardware and simulation',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://hackathon-1-frontend-book.vercel.app', // Vercel deployment URL
